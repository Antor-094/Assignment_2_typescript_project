...
const retrieveOrdersOfaSingleUser = async (req: Request, res: Response) => {
    try {
        ...
        // console.log(userId,orderData)
        const result = await userServices.retrieveOrdersOfaSingleUserDB(parseInt(userId))
        res.status(200).json({
            success: true,
...
const getTotalPriceForAnUsersOrder = async (req: Request, res: Response) => {
    try {
        ...
        // console.log(userId,orderData)
        const result = await userServices.getTotalPriceForAnUsersOrderDB(parseInt(userId))
        res.status(200).json({
            success: true,
